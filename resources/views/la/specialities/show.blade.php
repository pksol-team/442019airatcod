	...
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $speciality->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Specialities", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/specialities/'.$speciality->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Specialities", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.specialities.destroy', $speciality->id], 'method' => 'delete', 'style'=>'display:inline']) }}
