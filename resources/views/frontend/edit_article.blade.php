            ...
            <form action="/updateArticle" method="post" class="addNewArticle" enctype="multipart/form-data">
             ...
             <input type="hidden" name="article_id" value="{{ $article->id }}">
               <div class="row for-contact-label my-2">
                  ...
                  <div class="col-lg-10">
                     <input type="text" class="w-100 form-control" name="title" oninvalid="this.setCustomValidity('Por favor rellene este campo')" value="{{ $article->title }}" oninput="setCustomValidity('')" required>
                  </div>
               </div>
               <div class="row for-contact-label my-2">
                  <div class="col-lg-2 text-right">
                  ...
                  <div class="col-lg-10">
                     <input type="text" class="w-100 form-control" name="short_description" oninvalid="this.setCustomValidity('Por favor rellene este campo')" value="{{ $article->short_description }}" oninput="setCustomValidity('')" required>
                  </div>
               </div>
               <div class="row for-contact-label my-2">
                  <div class="col-lg-2 text-right">
