...
<section class="doctor_full_main_page">
   ...
   <div class="container">
      <div class="row">
         <div class="col-12">
            <form action="/addNewArticle" method="post" class="addNewArticle" enctype="multipart/form-data">
             ...
             <input type="hidden" name="user_id" value="{{ $EmpTbl->id }}">
               ...
               <div class="row for-contact-label my-2">
                  ...
                  <div class="col-lg-10">
                     <textarea class="form-control summernote_detail" name="detail"></textarea>
                  </div>
               </div>
               <div class="row for-contact-label my-2">
                  <div class="col-lg-2 text-right">
                  ...
                  <div class="col-lg-10">
                     <input type="file" accept=".jpg,.jpeg,.png.,.gif" class="w-100" name="image" required>
                  </div>
               </div>
               <div class="row for-contact-label my-2">
                  <div class="col-lg-2">
