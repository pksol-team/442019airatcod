...
class CreateArticlesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Articles", 'articles', 'title', 'fa-file-text-o', [
            ["title", "Title", "String", false, "", 0, 256, true],
            ["short_description", "Short Description", "String", false, "", 0, 256, true],
            ["detail", "Detail", "Textarea", false, "", 0, 0, false],
            ["user_id", "User", "Dropdown", false, "", 0, 0, true, "@employees"],
