...
class CreateTicketsRepliesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Tickets_replies", 'tickets_replies', 'message', 'fa-align-justify', [
            ["ticket_id", "Ticket", "Integer", false, "", 0, 11, true],
            ["reply_date", "Reply Date", "Date", false, "", 0, 0, false],
